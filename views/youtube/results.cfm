...
Last Search Result Revision: #LSDateFormat(rc.ytdata.dateupdated,'long')#
</div>
</cfoutput>
...
<cfoutput>
	...
	<div class="itemstat">
		...
		<!--- TODO: Potential bug in Open BlueDragon? ---><cfif not StructKeyExists(server,'bluedragon')>Last updated: #LSDateFormat(rc.ytdata.items[rc.i].dateupdated,'long')# - </cfif>
