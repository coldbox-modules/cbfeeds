...
<ol>
	<li class="orderedList"><a href="<cfoutput>#event.buildLink('generator.dumpFeedBeginner')#</cfoutput>">Display the Event used to create feed</a><p>We first use an Event to supply the data that is going to be used in the feed.<br />Event: <code>createFeedBeginner</code> in <code>/handlers/generator.cfc</code></p></li>
	<li class="orderedList"><a href="<cfoutput>#event.buildLink('generator.createFeedBeginner')#</cfoutput>">Generate feed</a><p>Then we run the event to create the RSS feed and save it to the ColdBox server as a XML document. Every time the feed is updated with new data, this event needs to be rerun.</p></li>
	<li class="orderedList"><a href="<cfoutput>#event.buildLink('generator.sourceFeedBeginner')#</cfoutput>">Display feed source</a><p>You can now view the generated feed as a human readable, plain text XML document.</p></li>
	<li class="orderedList"><a href="<cfoutput>#event.buildLink('generator.dumpDisplayFeedBeginner')#</cfoutput>">Display feed Event</a><p>To allow people to properly use your feed we create a new Event. It will read the RSS/XML document stored as a file on the server and copy it to the Request Collection variable <kbd>#rc.DumpXML#</kbd>.<br />Event: <code>displayFeedBeginner</code> in <code>/handlers/generator.cfc</code></p></li>
	<li class="orderedList"><a href="<cfoutput>#event.buildLink('generator.dumpLayoutXML')#</cfoutput>">Display Layout</a><p>We use a very simple Layout to serve the XML document.<br />Layout: <code>/layout/Layout.xml.cfm</code></p></li>
	<li class="orderedList"><a href="<cfoutput>#event.buildLink('generator.dumpvwPostGenerate')#</cfoutput>">Display View</a><p>This XML file that has been copied to the <kbd>#rc.DumpXML#</kbd> variable will be displayed using the vwPostGenerate View.<br />View: <code>/views/vwPostGenerate.cfm</code></p></li>
	<li class="orderedList"><a href="<cfoutput>#event.buildLink('generator.displayFeedBeginner')#</cfoutput>">Display feed</a><span class="note"> *</span><p>This Event is our public URL for the feed. It will correctly display the feed when used in any feed reader, such as Safari shown in the figure below. Internet Explorer 7, Firefox would also display something very similar.<br />Event: <code>displayFeedBeginner</code> in <code>/handlers/generator.cfc</code></p></li>
</ol>
<p>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedError')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedError')#</cfoutput>">Generate feed</a> <sub>(to trigger the debugger)</sub></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedPlayground')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedPlayground')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedPlayground')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedPlayground')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedSimpleArt')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedSimpleArt')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedSimpleArt')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedSimpleArt')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedCompleteArt')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedCompleteArt')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedCompleteArt')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedCompleteArt')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeediTunes')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeediTunes')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeediTunes')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeediTunes')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedOpenSearch')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedOpenSearch')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedOpenSearch')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedOpenSearch')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedDublinCore')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedDublinCore')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedDublinCore')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedDublinCore')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedSlash')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedSlash')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedSlash')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedSlash')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedComboEx')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedComboEx')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedComboEx')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedComboEx')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedInternational')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedInternational')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.sourceFeedInternational')#</cfoutput>">Display feed source</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedInternational')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpLayoutAutoDiscovery')#</cfoutput>">Display autodiscovery HTML code</a></li>
</ul>
...
<ul>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpFeedBandwidth')#</cfoutput>">Display code used to create feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.createFeedBandwidth')#</cfoutput>">Generate feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.dumpLayoutBandwidth')#</cfoutput>">Display Layout used to cache the feed</a></li>
	<li><a href="<cfoutput>#event.buildLink('generator.displayFeedBandwidth')#</cfoutput>">Display feed</a><span class="note"> *</span></li>
</ul>
